...
const scoreDelta = Math.max(0, qualificationAfter.score - qualificationBefore.score);
...
const normalizedSurvey = rawUpdates.survey && typeof rawUpdates.survey === 'object' && !Array.isArray(rawUpdates.survey)
  ? rawUpdates.survey
  : {};
const surveyLastQuestion = asTrimmedString(normalizedSurvey.last_question)
  || qualificationAfter.next_questions[0]?.prompt
  || null;
